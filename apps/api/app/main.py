...
from app.routers import actions, approvals, audit_logs, chat, execution, github_execution, github_mutation, mcp, memory, tasks
...
@app.get("/")
def root():
    return {"status": "healthy", "app": settings.APP_NAME, "version": "0.7.0"}
